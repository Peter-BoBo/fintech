...
# 1997년 1월 1일부터 2001년 12월 31일까지 환율변동 조회 (IMF...)
SELECT * FROM exchange_rate WHERE date
between '1997-01-01' and '2001-12-31';

# 통화별로 현찰_살때_환율, 현찰_팔때_환율의
# MIN() 살때최저환율, MAX() 살때최고환율, AVG() 살때평균환율alter
# MAX() - MIN () 살때평균변동량
# MIN() 팔때최저환율, MAX() 팔때최고환율, AVG() 팔때평균환율alter
# MAX() - MIN () 팔때평균변동량
...
UPDATE exchange_rate_1997_2001 SET 통화='미국' WHERE 살때_최저_환율=855.34;
